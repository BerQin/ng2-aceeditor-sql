(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('brace'), require('brace/theme/monokai'), require('brace/theme/xcode'), require('brace/mode/html'), require('brace/mode/sql'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'brace', 'brace/theme/monokai', 'brace/theme/xcode', 'brace/mode/html', 'brace/mode/sql', '@angular/forms'], factory) :
    (factory((global.ng = global.ng || {}, global.ng.ng2aceeditor = {}),global.ng.core,null,null,null,null,null,global.ng.forms));
}(this, (function (exports,core,brace,monokai,xcode,html,sql,forms) { 'use strict';
